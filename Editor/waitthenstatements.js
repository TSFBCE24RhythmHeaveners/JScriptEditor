...
{
  "type": "wait_seconds_then_do",
  "tooltip": "Wait for a specific amount of seconds, then do the statements.",
  "helpUrl": "https://www.sitepoint.com/delay-sleep-pause-wait/",
  "message0": "wait for %1 seconds then %2 do %3",
  "args0": [
    {
      "type": "input_value",
      "name": "seconds",
...
Blockly.JavaScript['wait_seconds_then_do'] = function(block)  {
