...
Blockly.inject.loadSounds_ = function(pathToMedia, workspace) {
  ...
  audioMgr.load(
      [
        pathToMedia + 'sounds_snap.mp3',
        pathToMedia + 'sounds_snap.wav',
        pathToMedia + 'sounds_snap.ogg'
      ], 'click');
  audioMgr.load(
      [
        pathToMedia + 'sounds_take.mp3',
        pathToMedia + 'sounds_take.wav',
        pathToMedia + 'sounds_take.ogg'
      ], 'disconnect');
  audioMgr.load(
      [
        pathToMedia + 'sounds_remove.mp3',
        pathToMedia + 'sounds_remove.',
        pathToMedia + 'sounds_remove.'
      ], 'delete');
